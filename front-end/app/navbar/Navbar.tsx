  ...
  return (
    <div className="w-screen bg-black text-white h-14  fixed top-0 left-0">
      <nav className="w-full  flex justify-between h-full items-center px-2 sm:px-8  mx-auto">
        ...
        <ul className="flex  text-xs sm:static fixed left-0 bottom-0 w-full sm:w-fit justify-center h-10 sm:h-14 items-center sm:gap-5 bg-black text-white  shadow-2xl ">
          <LinkNameSvg
