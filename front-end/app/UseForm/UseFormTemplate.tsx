...
const UseFormTemplate = (props: {
  ...
  return (
    <div className=" w-full  h-full ">
      ...
      >
        <div className="overflow-auto sm:px-1">
        ...
        <button
          type="submit"
          disabled={onSubmitMode}
          className="btn grow w-full  sm:w-full left-0 fixed bottom-8 sm:static shadow-md btn-primary mt-1 sm:rounded-md rounded-none  "
        >
          {onSubmitMode ? (
            <>
